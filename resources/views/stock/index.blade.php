...
{{--                </div>--}}
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('stock_create_page') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'type', 'render': function ( data, type, row ) {
                                if(data === 'IN'){
                                    return '<span class="label label-lg font-weight-bold label-rounded label-success">'+data+'</span>';
                                } else{
                                    return '<span class="label label-lg font-weight-bold label-rounded label-danger">'+data+'</span>';
                                }
                            }},
                        {data: 'Actions'},
                    ],
